...
const Calender = () => {
    ...
    return (
        <>
            <Head>
                <title>Intelligent Email Reader/Calendar</title>
                ...
                >
                    ...
                    <div className="flex flex-row items-center justify-center gap-5">
                        <PageButton
                            ...
                            ariaLabel={"click to list all tasks"}
                            isActive={showTasks}
                            text={"List Tasks"}
                            customFunction={allTasksPress}
                        />
                        <PageButton
                            icon={<Add />}
                            ariaLabel={"click to add a new task"}
                            isActive={showAddTask}
                            text={"Add a Task"}
                            customFunction={addTaskPress}
                        />
                    </div>
                    <Line />
