...
const Home = () => {
	return (
		<>
			...
			<main
				className='flex h-full md:h-screen w-screen bg-primary py-16 md:p-10'
				aria-label='landing page'
				tabIndex={0}
			>
				<div className='z-10 w-100 h-100 m-auto flex flex-col-reverse md:flex-row justify-evenly items-center gap-10 bg-white p-3 md:p-20 rounded-xl border-4 shadow-md'>
					<div
						className='flex flex-1 flex-col h-100 w-1/2 items-center justify-start gap-4'
						tabIndex={0}
					>
						<h1
							className='font-extrabold font-poppins text-5xl uppercase text-primary text-left'
							role='heading'
							aria-level='1'
					...
					<div className=' h-100 w-1/2 flex'>
						<div className='rounded-xl m-auto p-2'>
							<Image
								src={"/ld.jpg"}
								alt='landing image'
								className='w-100 h-full rounded-full border-2 border-y-primary border-x-tertiary shadow-xl'
								width={450}
								height={450}
								role='img'
