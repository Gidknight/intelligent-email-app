            ...
            <section className="flex flex-col justify-center items-center w-full">
                ...
                >
                    ...
                    <div className="flex flex-row w-100 items-center justify-center gap-1 md:gap-5">
                        <PageButton
                            ariaLabel={"click to show all contacts"}
                            customFunction={handleAllContactsPress}
                            isActive={showContacts}
                            icon={<ListAlt />}
                            text={"All Contacts"}
                        />
                        <PageButton
                            ariaLabel={"click to add a new contact"}
                            customFunction={handleAddContactPress}
                            isActive={showAddContact}
                            icon={<Add />}
                            text={"Add Contact"}
                        />
                    </div>
