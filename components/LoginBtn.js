...
const Component = () => {
	...
	const divStyle = `flex flex-row items-center justify-center bg-gray-200 gap-5 font-semibold px-2 rounded-lg mt-4`;
	...
	if (!session) {
		return (
			<div className={divStyle}>
				<p className={`text-red-500`} role='status' tabIndex={0}>
					Not Signed In:
				</p>
	...
	return (
		<div className={divStyle}>
			<p className='text-green-500' role='status' tabIndex={0}>
