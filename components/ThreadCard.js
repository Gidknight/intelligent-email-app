...
const ThreadCard = ({ subject, to, from, snippet, messages, id, date }) => {
	...
	return (
		<button
			...
			key={id}
		>
			<div className='cursor-not-allowed bg-gray1 hover:bg-tertiary focus:bg-tertiary w-100 px-1 md:px-5 h-100 rounded-2xl flex hover:shadow-xl  hover:scale-105 transition-all duration-300 gap-5'>
