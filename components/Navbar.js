	...
	return (
		...
		>
			<nav className='flex flex-row items-center justify-between p-2 md:ml-6 md:mr-6 relative text-primary'>
				...
				{sidebar && (
					<div className='flex flex-col justify-start gap-2 absolute right-1 top-2 bg-slate-50 w-96 h-screen'>
						...
						<div className='flex flex-col items-center justify-center gap-2 shadow-lg bg-primary p-2 text-white'>
							<Image
								src={session?.user?.image}
								alt='profile picture'
								width={50}
								...
								className='rounded-full'
							/>
							<h2 className='font-bold ml-5 my-auto text-xl capitalize'>
