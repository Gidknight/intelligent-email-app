...
const Recipient = ({
    ...
    popToast("speak to add recipient");
    ...
    return (
        <div>
            <fieldset className={fieldsetStyle}>
                ...
                <TextInput
                    aria={
                        "enter the recipient email address without the suffix: @gmail.com, as it will be added for you"
                    }
...
const Subject = ({
    ...
    const addSubject = () => {
        ...
        // Show success message
        toast.success(`subject added successfully, speak to add message`);
    };
    ...
    const handlePrev = (e) => {
        ...
        setShowSubject(false);
        popToast("speak to change recipient");
    };
    return (
        <div>
            <fieldset className={fieldsetStyle}>
...
const Body = ({
    ...
    const handlePrev = (event) => {
        ...
        setShowRecipient(false);
        setShowSubject(true);
        popToast("speak to change subject");
    };
    return (
        <div>
            <fieldset className={fieldsetStyle}>
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-10 w-100 items-center justify-evenly">
                <form
                    onSubmit={handleSend}
                    className="flex flex-col gap-2 md:gap-5 border-2 border-gray-500 p-2 md:p-5 rounded-xl w-full md:w-1/2"
                >
